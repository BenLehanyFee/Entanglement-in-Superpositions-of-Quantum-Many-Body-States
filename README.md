...
Contains a reduced density matrix, and calculators for both the Rényi-2 and von Neumann entropy. Also includes validation tests, (verifying Bell states have maximal entropy, product states have 0 entropy, and that any bipartition of a closed qwuantum system has equal entropy across both subsystems).
All validation tests can be replicated by the included Boolean variables at the top of the code.
...
All plots used within my report can be replicated using the Boolean variables at the top of the code.
